...
class InfDPS 
{
     ...
     */
    public \Nfse\Enums\V1_0_0\TSEmitenteDPS $tpEmit;
     ...
     */
    public ?\NFSe\Dto\V1_0_0\DPS\InfDPS\Substituicao $subst = null;

    /**
     * Grupo de informações do DPS relativas ao Prestador de Serviços
     */
    public \NFSe\Dto\V1_0_0\DPS\InfDPS\InfoPrestador $prest;

    /**
     * Grupo de informações do DPS relativas ao Tomador de Serviços
     */
    public ?\NFSe\Dto\V1_0_0\DPS\InfDPS\InfoPessoa $toma = null;

    /**
     * Grupo de informações do DPS relativas ao Intermediário de Serviços
     */
    public ?\NFSe\Dto\V1_0_0\DPS\InfDPS\InfoPessoa $interm = null;

    /**
     * Grupo de informações do DPS relativas ao Serviço Prestado
     */
    public \NFSe\Dto\V1_0_0\DPS\InfDPS\Serv $serv;

    /**
     * Grupo de informações relativas à valores do serviço prestado
     */
    public \NFSe\Dto\V1_0_0\DPS\InfDPS\InfoValores $valores;
