...
class InfNFSe 
{
     ...
     */
    public \Nfse\Enums\V1_0_0\TSAmbGeradorNFSe $ambGer;
     ...
     */
    public \Nfse\Enums\V1_0_0\TSTipoEmissao $tpEmis;
     ...
     * 3 - Emissão com aplicativo disponibilizado pelo fisco (App);
     */
    public \Nfse\Enums\V1_0_0\TSProcEmissao $procEmi;

    /**
     * Código do Status da mensagem
     */
    public \Nfse\Enums\V1_0_0\TStat $cStat;
     ...
     */
    public \NFSe\Dto\V1_0_0\NFSe\InfNFSe\Emitente $emit;

    /**
     * Grupo de valores referentes ao Serviço Prestado
     */
    public \NFSe\Dto\V1_0_0\NFSe\InfNFSe\ValoresNFSe $valores;

    /**
     * Grupo de informações da DPS relativas ao serviço prestado
     */
    public \NFSe\Dto\V1_0_0\DPS $DPS;
