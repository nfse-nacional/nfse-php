...
class InfoTributacao 
{
     ...
     */
    public \NFSe\Dto\V1_0_1\DPS\InfDPS\InfoValores\InfoTributacao\TribMunicipal $tribMun;

    /**
     * Grupo de informações de outros tributos relacionados ao serviço prestado
     */
    public ?\NFSe\Dto\V1_0_1\DPS\InfDPS\InfoValores\InfoTributacao\TribFederal $tribFed = null;

    /**
     * Grupo de informações para totais aproximados dos tributos relacionados ao serviço prestado
     */
    public \NFSe\Dto\V1_0_1\DPS\InfDPS\InfoValores\InfoTributacao\TribTotal $totTrib;
