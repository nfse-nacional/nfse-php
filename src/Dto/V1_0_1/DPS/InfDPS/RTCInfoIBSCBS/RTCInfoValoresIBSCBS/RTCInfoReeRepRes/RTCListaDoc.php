...
namespace NFSe\Dto\V1_0_1\DPS\InfDPS\RTCInfoIBSCBS\RTCInfoValoresIBSCBS\RTCInfoReeRepRes;
...
class RTCListaDoc 
{
     ...
     */
    public \NFSe\Dto\V1_0_1\DPS\InfDPS\RTCInfoIBSCBS\RTCInfoValoresIBSCBS\RTCInfoReeRepRes\RTCListaDoc\RTCListaDocDFe $dFeNacional;

    /**
     * Grupo de informações de documento fiscais, eletrônicos ou não, que não se encontram no
     * repositório nacional
     */
    public \NFSe\Dto\V1_0_1\DPS\InfDPS\RTCInfoIBSCBS\RTCInfoValoresIBSCBS\RTCInfoReeRepRes\RTCListaDoc\RTCListaDocFiscalOutro $docFiscalOutro;

    /**
     * Grupo de informações de documento não fiscal.
     */
    public \NFSe\Dto\V1_0_1\DPS\InfDPS\RTCInfoIBSCBS\RTCInfoValoresIBSCBS\RTCInfoReeRepRes\RTCListaDoc\RTCListaDocOutro $docOutro;

    /**
     * Grupo de informações do fornecedor do documento referenciado
     */
    public ?\NFSe\Dto\V1_0_1\DPS\InfDPS\RTCInfoIBSCBS\RTCInfoValoresIBSCBS\RTCInfoReeRepRes\RTCListaDoc\RTCListaDocFornec $fornec = null;
     ...
     * referenciados
     */
    public \Nfse\Enums\V1_0_1\TSRTCTpReeRepRes $tpReeRepRes;
