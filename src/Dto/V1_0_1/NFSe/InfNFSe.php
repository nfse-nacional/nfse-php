...
namespace NFSe\Dto\V1_0_1\NFSe;
...
class InfNFSe 
{
     ...
     */
    public \Nfse\Enums\V1_0_1\TSAmbGeradorNFSe $ambGer;
     ...
     */
    public \Nfse\Enums\V1_0_1\TSTipoEmissao $tpEmis;
     ...
     * 3 - Emissão com aplicativo disponibilizado pelo fisco (App);
     */
    public ?\Nfse\Enums\V1_0_1\TSProcEmissao $procEmi = null;

    /**
     * Código do Status da mensagem
     */
    public \Nfse\Enums\V1_0_1\TStat $cStat;
     ...
     */
    public \NFSe\Dto\V1_0_1\NFSe\InfNFSe\Emitente $emit;
     ...
     */
    public \NFSe\Dto\V1_0_1\NFSe\InfNFSe\ValoresNFSe $valores;

    /**
     * Grupo de informações geradas pelo sistema referentes ao IBS e à CBS
     */
    public ?\NFSe\Dto\V1_0_1\NFSe\InfNFSe\RTCIBSCBS $IBSCBS = null;

    /**
     * Grupo de informações da DPS relativas ao serviço prestado
     */
    public \NFSe\Dto\V1_0_1\DPS $DPS;
